...
<!-- badges: start -->
[![R-CMD-check](https://github.com/r-lib/lazytest/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/r-lib/lazytest/actions/workflows/R-CMD-check.yaml)
